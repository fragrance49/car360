...
def Apicall(request):
    ...
    r = requests.post('https://us-central1-glo3d-c338b.cloudfunctions.net/api', data ={'vin_number':'12MCU9GD8JUD10045'}, auth = HTTPBasicAuth('info@activedevtech.com', '2rdFUSR01j4'))  
    # print(r.json())
    data = r.json()
    # print(data)
